...
export default function DuLieuDaXoaGanDay({
  ...
  const renderApplyKeyDuAn = () => {
    router.push('/quan-ly-du-lieu-da-xoa-gan-day/quan-ly-du-an-da-xoa-gan-day');
  };

  const renderApplyKeyQuyTrinh = () => {
    router.push(
      '/quan-ly-du-lieu-da-xoa-gan-day/quan-ly-quy-trinh-da-xoa-gan-day'
    );
  };
  const renderApplyKeyTaiLieu = () => {
    router.push(
      '/quan-ly-du-lieu-da-xoa-gan-day/quan-ly-tai-lieu-da-xoa-gan-day'
    );
  };

  const renderApplyKeyCuocHop = () => {
    router.push(
      '/quan-ly-du-lieu-da-xoa-gan-day/quan-ly-cuoc-hop-da-xoa-gan-day'
    );
  };
  const { Search } = Input;
