...
import styles from './chitiettheoquytrinh.module.scss';
import BaChamNgang from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/Bachamngang';
import Giaidoan from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/Bacham/Giaidoan/Giaidoan';
import Bacham from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/Bacham/HTTB/Bacham';
import Chamnv from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/Bacham/Nhiemvu/Chamnv';
import { Input } from 'antd';
import ThemNhiemVuMoi from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/ThemNhiemVuMoi';
import Boloc from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/Boloc';
// import Dragdrop from './dragdrop';
import { POST } from '@/pages/api/auth';
import { Stage, fetchStages } from '@/store/actions/stagesActions';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '@/store/reducers';
import DragDropExample from '@/components/quan-ly-du-an/theo-quy-trinh/Chitiettheoquytinh/DragDropCustomize';
