...
import Themmoiquytrinh from '@/components/quan-ly-du-an/theo-quy-trinh/Themmoiquytrinh';
...
export default function Tqt({
  ...
  const onClick = (info: any) => {
    ...
    router.push(
      `/quan-ly-du-an-theo-quy-trinh/chi-tiet-du-an-theo-quy-trinh?process_id=${info.id}`
    );
  };
  const { Search } = Input;
